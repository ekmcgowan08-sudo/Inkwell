  ...
  return (
    <SafeAreaView style={styles.page} edges={["top"]}>
      ...
      <Text style={styles.note}>
        Biometric app lock, offline writing, and the rest of Inkwell's mobile screens (story bible, storyboard, timeline, AI assistant) are planned
        but not yet built for mobile — see docs/IMPLEMENTATION_STATUS.md.
      </Text>
    </SafeAreaView>
  );
}
