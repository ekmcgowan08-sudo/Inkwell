 ...
 */
const WORD_BANK = [
  "the", "raven", "circled", "tower", "ancient", "stone", "whispered", "shadow", "dawn", "crown",
  "exile", "kingdom", "betrayal", "fire", "ash", "wind", "silence", "blade", "oath", "blood",
  "court", "throne", "ghost", "storm", "memory", "wolf", "forest", "river", "mountain", "star",
  "night", "sword", "banner", "knight", "queen", "king", "prophecy", "curse", "flame", "iron",
  "letter", "sealed", "message", "army", "border", "village", "temple", "priestess", "omen", "tide",
];
